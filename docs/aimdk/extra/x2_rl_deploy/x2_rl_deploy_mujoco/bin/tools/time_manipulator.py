...
class URLApp:
    def __init__(self, root):
        ...
        self.url_entry.insert(
            0, "http://127.0.0.1:51822/rpc/aimrt.protocols.time_manipulator_plugin.TimeManipulatorService/SetTimeRatio")
        self.url_entry.pack()
        ...
        self.toggle_button = ttk.Checkbutton(
            root, text="Start", command=self.toggle)
        ...
        if url:
            try:
                ...
                json_data = json.dumps(
                    {'executor_name': executor_name, 'time_ratio': self.discrete_values[index]})
