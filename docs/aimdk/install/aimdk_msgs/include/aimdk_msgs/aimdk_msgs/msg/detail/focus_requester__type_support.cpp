...
{
  new (message_memory) aimdk_msgs::msg::FocusRequester(_init);
}

void FocusRequester_fini_function(void * message_memory)
{
  auto typed_message = static_cast<aimdk_msgs::msg::FocusRequester *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FocusRequester_message_member_array[3] = {
  {
    ...
    offsetof(aimdk_msgs::msg::FocusRequester, pkg_name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aimdk_msgs::msg::FocusRequester, priority),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aimdk_msgs::msg::FocusRequester, priority_weight),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FocusRequester_message_members = {
  ...
  3,  // number of fields
  sizeof(aimdk_msgs::msg::FocusRequester),
...
get_message_type_support_handle<aimdk_msgs::msg::FocusRequester>()
{
  return &::aimdk_msgs::msg::rosidl_typesupport_introspection_cpp::FocusRequester_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aimdk_msgs, msg, FocusRequester)() {
  return &::aimdk_msgs::msg::rosidl_typesupport_introspection_cpp::FocusRequester_message_type_support_handle;
}
