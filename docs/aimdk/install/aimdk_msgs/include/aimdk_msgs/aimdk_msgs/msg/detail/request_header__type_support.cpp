...
{
  new (message_memory) aimdk_msgs::msg::RequestHeader(_init);
}

void RequestHeader_fini_function(void * message_memory)
{
  auto typed_message = static_cast<aimdk_msgs::msg::RequestHeader *>(message_memory);
  typed_message->~RequestHeader();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember RequestHeader_message_member_array[1] = {
  {
    "stamp",  // name
    ...
    offsetof(aimdk_msgs::msg::RequestHeader, stamp),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RequestHeader_message_members = {
  ...
  1,  // number of fields
  sizeof(aimdk_msgs::msg::RequestHeader),
...
get_message_type_support_handle<aimdk_msgs::msg::RequestHeader>()
{
  return &::aimdk_msgs::msg::rosidl_typesupport_introspection_cpp::RequestHeader_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aimdk_msgs, msg, RequestHeader)() {
  return &::aimdk_msgs::msg::rosidl_typesupport_introspection_cpp::RequestHeader_message_type_support_handle;
}
