...
#ifndef AIMDK_MSGS__MSG__DETAIL__AUDIO_PLAYBACK__TRAITS_HPP_
#define AIMDK_MSGS__MSG__DETAIL__AUDIO_PLAYBACK__TRAITS_HPP_
...
inline void to_yaml(
  const aimdk_msgs::msg::AudioPlayback & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const aimdk_msgs::msg::AudioPlayback & msg)
{
  return aimdk_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<aimdk_msgs::msg::AudioPlayback>()
{
  return "aimdk_msgs::msg::AudioPlayback";
}

template<>
inline const char * name<aimdk_msgs::msg::AudioPlayback>()
{
  return "aimdk_msgs/msg/AudioPlayback";
}

template<>
struct has_fixed_size<aimdk_msgs::msg::AudioPlayback>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<aimdk_msgs::msg::AudioPlayback>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<aimdk_msgs::msg::AudioPlayback>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // AIMDK_MSGS__MSG__DETAIL__AUDIO_PLAYBACK__TRAITS_HPP_
