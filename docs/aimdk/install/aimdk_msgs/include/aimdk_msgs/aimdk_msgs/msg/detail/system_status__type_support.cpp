...
{
  new (message_memory) aimdk_msgs::msg::SystemStatus(_init);
}

void SystemStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<aimdk_msgs::msg::SystemStatus *>(message_memory);
  typed_message->~SystemStatus();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember SystemStatus_message_member_array[1] = {
  {
    "value",  // name
    ...
    offsetof(aimdk_msgs::msg::SystemStatus, value),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SystemStatus_message_members = {
  ...
  1,  // number of fields
  sizeof(aimdk_msgs::msg::SystemStatus),
...
get_message_type_support_handle<aimdk_msgs::msg::SystemStatus>()
{
  return &::aimdk_msgs::msg::rosidl_typesupport_introspection_cpp::SystemStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aimdk_msgs, msg, SystemStatus)() {
  return &::aimdk_msgs::msg::rosidl_typesupport_introspection_cpp::SystemStatus_message_type_support_handle;
}
