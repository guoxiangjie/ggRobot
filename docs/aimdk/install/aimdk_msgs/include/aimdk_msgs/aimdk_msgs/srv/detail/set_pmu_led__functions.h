...
#ifndef AIMDK_MSGS__SRV__DETAIL__SET_PMU_LED__FUNCTIONS_H_
#define AIMDK_MSGS__SRV__DETAIL__SET_PMU_LED__FUNCTIONS_H_
...
/// Initialize srv/SetPmuLed message.
/**
...
/// Finalize srv/SetPmuLed message.
/**
...
/// Create srv/SetPmuLed message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * aimdk_msgs__srv__SetPmuLed_Request__init().
...
/// Destroy srv/SetPmuLed message.
/**
 * It calls
 * aimdk_msgs__srv__SetPmuLed_Request__fini()
...
/// Check for srv/SetPmuLed message equality.
/**
...
/// Initialize array of srv/SetPmuLed messages.
/**
...
/// Finalize array of srv/SetPmuLed messages.
/**
 * It calls
 * aimdk_msgs__srv__SetPmuLed_Request__fini()
...
/// Create array of srv/SetPmuLed messages.
/**
 * It allocates the memory for the array and calls
 * aimdk_msgs__srv__SetPmuLed_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetPmuLed messages.
/**
 * It calls
 * aimdk_msgs__srv__SetPmuLed_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetPmuLed message array equality.
/**
...
/// Copy an array of srv/SetPmuLed messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * aimdk_msgs__srv__SetPmuLed_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aimdk_msgs
...
/**
 * It calls
 * aimdk_msgs__srv__SetPmuLed_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_aimdk_msgs
...
/**
 * It allocates the memory for the array and calls
 * aimdk_msgs__srv__SetPmuLed_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aimdk_msgs
...
/**
 * It calls
 * aimdk_msgs__srv__SetPmuLed_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AIMDK_MSGS__SRV__DETAIL__SET_PMU_LED__FUNCTIONS_H_
