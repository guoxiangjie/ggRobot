...
#ifndef AIMDK_MSGS__SRV__DETAIL__REQUEST_AUDIO_FOCUS__FUNCTIONS_H_
#define AIMDK_MSGS__SRV__DETAIL__REQUEST_AUDIO_FOCUS__FUNCTIONS_H_
 ...
 * calls
 * aimdk_msgs__srv__RequestAudioFocus_Request__init().
...
/**
 * It calls
 * aimdk_msgs__srv__RequestAudioFocus_Request__fini()
 ...
 * aimdk_msgs__srv__RequestAudioFocus_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * aimdk_msgs__srv__RequestAudioFocus_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * aimdk_msgs__srv__RequestAudioFocus_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aimdk_msgs
...
/**
 * It calls
 * aimdk_msgs__srv__RequestAudioFocus_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_aimdk_msgs
...
/**
 * It allocates the memory for the array and calls
 * aimdk_msgs__srv__RequestAudioFocus_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aimdk_msgs
...
/**
 * It calls
 * aimdk_msgs__srv__RequestAudioFocus_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AIMDK_MSGS__SRV__DETAIL__REQUEST_AUDIO_FOCUS__FUNCTIONS_H_
