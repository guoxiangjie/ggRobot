...
bool aimdk_msgs__msg__common_state__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool aimdk_msgs__msg__common_task_response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._common_task_response.CommonTaskResponse", full_classname_dest, 55) == 0);
  }
  aimdk_msgs__msg__CommonTaskResponse * ros_message = _ros_message;
  {  // header
  ...
  {  // state
    ...
    if (!aimdk_msgs__msg__common_state__convert_from_py(field, &ros_message->state)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of CommonTaskResponse */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._common_task_response");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CommonTaskResponse");
  ...
  {  // state
    PyObject * field = NULL;
    field = aimdk_msgs__msg__common_state__convert_to_py(&ros_message->state);
    if (!field) {
      return NULL;
    }
    {
