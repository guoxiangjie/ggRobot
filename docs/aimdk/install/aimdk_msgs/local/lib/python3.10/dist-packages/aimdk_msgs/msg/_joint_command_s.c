...
bool aimdk_msgs__msg__joint_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._joint_command.JointCommand", full_classname_dest, 42) == 0);
  }
  aimdk_msgs__msg__JointCommand * ros_message = _ros_message;
  {  // name
...
PyObject * aimdk_msgs__msg__joint_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._joint_command");
