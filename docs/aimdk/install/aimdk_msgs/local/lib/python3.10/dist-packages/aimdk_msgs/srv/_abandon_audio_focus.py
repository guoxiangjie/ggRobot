...
class Metaclass_AbandonAudioFocus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'aimdk_msgs.srv.AbandonAudioFocus')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from aimdk_msgs.srv import _abandon_audio_focus
...
class AbandonAudioFocus(metaclass=Metaclass_AbandonAudioFocus):
    from aimdk_msgs.srv._abandon_audio_focus import AbandonAudioFocus_Request as Request
    from aimdk_msgs.srv._abandon_audio_focus import AbandonAudioFocus_Response as Response
