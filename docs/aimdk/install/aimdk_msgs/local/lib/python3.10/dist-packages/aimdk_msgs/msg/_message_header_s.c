...
bool aimdk_msgs__msg__message_header__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._message_header.MessageHeader", full_classname_dest, 44) == 0);
  }
  aimdk_msgs__msg__MessageHeader * ros_message = _ros_message;
  {  // stamp
  ...
  {  // meas_stamp
    PyObject * field = PyObject_GetAttrString(_pymsg, "meas_stamp");
    if (!field) {
      return false;
    }
    if (!builtin_interfaces__msg__time__convert_from_py(field, &ros_message->meas_stamp)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * aimdk_msgs__msg__message_header__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._message_header");
  ...
  {  // meas_stamp
    PyObject * field = NULL;
    field = builtin_interfaces__msg__time__convert_to_py(&ros_message->meas_stamp);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "meas_stamp", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
