...
bool aimdk_msgs__msg__play_media_file_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._play_media_file_request.PlayMediaFileRequest", full_classname_dest, 60) == 0);
  }
  aimdk_msgs__msg__PlayMediaFileRequest * ros_message = _ros_message;
  {  // file_name
...
{
  /* NOTE(esteve): Call constructor of PlayMediaFileRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._play_media_file_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlayMediaFileRequest");
