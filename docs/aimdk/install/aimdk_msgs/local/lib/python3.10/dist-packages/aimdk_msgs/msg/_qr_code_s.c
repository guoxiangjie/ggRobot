...
bool aimdk_msgs__msg__qr_code__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._qr_code.QRCode", full_classname_dest, 30) == 0);
  }
  aimdk_msgs__msg__QRCode * ros_message = _ros_message;
  {  // code
...
{
  /* NOTE(esteve): Call constructor of QRCode */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._qr_code");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "QRCode");
