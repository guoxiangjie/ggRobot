...
bool aimdk_msgs__msg__domain_error_state__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool aimdk_msgs__msg__joint_state_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._joint_state_array.JointStateArray", full_classname_dest, 49) == 0);
  }
  aimdk_msgs__msg__JointStateArray * ros_message = _ros_message;
  {  // header
  ...
  {  // state
    ...
    if (!aimdk_msgs__msg__domain_error_state__convert_from_py(field, &ros_message->state)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // joints
    ...
    if (!aimdk_msgs__msg__JointState__Sequence__init(&(ros_message->joints), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create aimdk_msgs__msg__JointState__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    aimdk_msgs__msg__JointState * dest = ros_message->joints.data;
...
PyObject * aimdk_msgs__msg__joint_state_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._joint_state_array");
  ...
  {  // state
    PyObject * field = NULL;
    field = aimdk_msgs__msg__domain_error_state__convert_to_py(&ros_message->state);
    if (!field) {
      return NULL;
    }
    {
