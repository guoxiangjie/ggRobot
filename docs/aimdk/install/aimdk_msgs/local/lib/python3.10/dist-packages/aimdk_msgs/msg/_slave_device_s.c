...
bool aimdk_msgs__msg__slave_device__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._slave_device.SlaveDevice", full_classname_dest, 40) == 0);
  }
  aimdk_msgs__msg__SlaveDevice * ros_message = _ros_message;
  {  // ip
...
{
  /* NOTE(esteve): Call constructor of SlaveDevice */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._slave_device");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SlaveDevice");
