...
bool aimdk_msgs__msg__focus_requester__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._focus_requester.FocusRequester", full_classname_dest, 46) == 0);
  }
  aimdk_msgs__msg__FocusRequester * ros_message = _ros_message;
  {  // pkg_name
...
PyObject * aimdk_msgs__msg__focus_requester__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._focus_requester");
