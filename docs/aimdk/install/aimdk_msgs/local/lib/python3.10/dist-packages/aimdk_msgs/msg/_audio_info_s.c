...
bool aimdk_msgs__msg__audio_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._audio_info.AudioInfo", full_classname_dest, 36) == 0);
  }
  aimdk_msgs__msg__AudioInfo * ros_message = _ros_message;
  {  // channels
...
PyObject * aimdk_msgs__msg__audio_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._audio_info");
