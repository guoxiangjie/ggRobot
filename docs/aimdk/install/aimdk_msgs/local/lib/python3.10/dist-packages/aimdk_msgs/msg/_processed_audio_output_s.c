...
bool aimdk_msgs__msg__audio_vad_state_type__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * aimdk_msgs__msg__audio_vad_state_type__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool aimdk_msgs__msg__processed_audio_output__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._processed_audio_output.ProcessedAudioOutput", full_classname_dest, 59) == 0);
  }
  aimdk_msgs__msg__ProcessedAudioOutput * ros_message = _ros_message;
  {  // header
  ...
  {  // stream_id
    ...
    ros_message->stream_id = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // audio_vad_state
    PyObject * field = PyObject_GetAttrString(_pymsg, "audio_vad_state");
    if (!field) {
      return false;
    }
    if (!aimdk_msgs__msg__audio_vad_state_type__convert_from_py(field, &ros_message->audio_vad_state)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of ProcessedAudioOutput */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._processed_audio_output");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ProcessedAudioOutput");
  ...
  {  // audio_vad_state
    PyObject * field = NULL;
    field = aimdk_msgs__msg__audio_vad_state_type__convert_to_py(&ros_message->audio_vad_state);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "audio_vad_state", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
