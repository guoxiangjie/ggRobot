...
bool aimdk_msgs__msg__response_header__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._response_header.ResponseHeader", full_classname_dest, 46) == 0);
  }
  aimdk_msgs__msg__ResponseHeader * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of ResponseHeader */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._response_header");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ResponseHeader");
