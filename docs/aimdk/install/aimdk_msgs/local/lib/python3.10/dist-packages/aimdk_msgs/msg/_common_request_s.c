...
bool aimdk_msgs__msg__common_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._common_request.CommonRequest", full_classname_dest, 44) == 0);
  }
  aimdk_msgs__msg__CommonRequest * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of CommonRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._common_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CommonRequest");
