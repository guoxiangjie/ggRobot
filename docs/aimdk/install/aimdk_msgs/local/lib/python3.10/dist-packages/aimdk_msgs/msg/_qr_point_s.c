...
bool aimdk_msgs__msg__qr_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._qr_point.QRPoint", full_classname_dest, 32) == 0);
  }
  aimdk_msgs__msg__QRPoint * ros_message = _ros_message;
  {  // point_id
  ...
  {  // qr_code
    PyObject * field = PyObject_GetAttrString(_pymsg, "qr_code");
    if (!field) {
      return false;
    }
    if (!aimdk_msgs__msg__qr_code__convert_from_py(field, &ros_message->qr_code)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of QRPoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._qr_point");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "QRPoint");
  ...
  {  // qr_code
    PyObject * field = NULL;
    field = aimdk_msgs__msg__qr_code__convert_to_py(&ros_message->qr_code);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "qr_code", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
