...
if(EXISTS "${PREBUILT_PACKAGE_PATH}")
  ...
  # 检查预编译包是否有效
  message(STATUS "DEBUG: Checking prebuilt package structure at: ${PREBUILT_PACKAGE_PATH}")
  message(STATUS "DEBUG: share/${PROJECT_NAME} path: ${PREBUILT_PACKAGE_PATH}/share/${PROJECT_NAME}")
  message(STATUS "DEBUG: include path: ${PREBUILT_PACKAGE_PATH}/include")
  message(STATUS "DEBUG: lib path: ${PREBUILT_PACKAGE_PATH}/lib")

  # 分别检查各个目录是否存在
  if(EXISTS "${PREBUILT_PACKAGE_PATH}/share/${PROJECT_NAME}")
    message(STATUS "DEBUG: share/${PROJECT_NAME} exists")
  else()
    message(STATUS "DEBUG: share/${PROJECT_NAME} does NOT exist")
  endif()

  if(EXISTS "${PREBUILT_PACKAGE_PATH}/include")
    message(STATUS "DEBUG: include exists")
  else()
    message(STATUS "DEBUG: include does NOT exist")
  endif()

  if(EXISTS "${PREBUILT_PACKAGE_PATH}/lib")
    message(STATUS "DEBUG: lib exists")
  else()
    message(STATUS "DEBUG: lib does NOT exist")
  endif()
