...
aimdk_msgs__msg__McControlArea__create()
{
  ...
  aimdk_msgs__msg__McControlArea * msg = (aimdk_msgs__msg__McControlArea *)allocator.allocate(sizeof(aimdk_msgs__msg__McControlArea), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(aimdk_msgs__msg__McControlArea));
  bool success = aimdk_msgs__msg__McControlArea__init(msg);
  if (!success) {
...
aimdk_msgs__msg__McControlArea__destroy(aimdk_msgs__msg__McControlArea * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    aimdk_msgs__msg__McControlArea__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
aimdk_msgs__msg__McControlArea__Sequence__init(aimdk_msgs__msg__McControlArea__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aimdk_msgs__msg__McControlArea * data = NULL;

  if (size) {
    data = (aimdk_msgs__msg__McControlArea *)allocator.zero_allocate(size, sizeof(aimdk_msgs__msg__McControlArea), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = aimdk_msgs__msg__McControlArea__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        aimdk_msgs__msg__McControlArea__fini(&data[i - 1]);
      }
...
aimdk_msgs__msg__McControlArea__Sequence__fini(aimdk_msgs__msg__McControlArea__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      aimdk_msgs__msg__McControlArea__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aimdk_msgs__msg__McControlArea__Sequence * array = (aimdk_msgs__msg__McControlArea__Sequence *)allocator.allocate(sizeof(aimdk_msgs__msg__McControlArea__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = aimdk_msgs__msg__McControlArea__Sequence__init(array, size);
  if (!success) {
...
aimdk_msgs__msg__McControlArea__Sequence__destroy(aimdk_msgs__msg__McControlArea__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    aimdk_msgs__msg__McControlArea__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
aimdk_msgs__msg__McControlArea__Sequence__are_equal(const aimdk_msgs__msg__McControlArea__Sequence * lhs, const aimdk_msgs__msg__McControlArea__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!aimdk_msgs__msg__McControlArea__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  aimdk_msgs__msg__McControlArea__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(aimdk_msgs__msg__McControlArea);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    aimdk_msgs__msg__McControlArea * data =
      (aimdk_msgs__msg__McControlArea *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!aimdk_msgs__msg__McControlArea__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          aimdk_msgs__msg__McControlArea__fini(&output->data[i]);
        }
        return false;
      }
    }
