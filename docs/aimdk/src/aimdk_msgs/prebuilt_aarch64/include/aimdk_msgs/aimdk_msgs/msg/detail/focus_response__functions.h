...
#ifndef AIMDK_MSGS__MSG__DETAIL__FOCUS_RESPONSE__FUNCTIONS_H_
#define AIMDK_MSGS__MSG__DETAIL__FOCUS_RESPONSE__FUNCTIONS_H_
 ...
 * calls
 * aimdk_msgs__msg__FocusResponse__init().
...
/**
 * It calls
 * aimdk_msgs__msg__FocusResponse__fini()
 ...
 * aimdk_msgs__msg__FocusResponse__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * aimdk_msgs__msg__FocusResponse__Sequence__fini()
 * on the array,
...
#endif  // AIMDK_MSGS__MSG__DETAIL__FOCUS_RESPONSE__FUNCTIONS_H_
