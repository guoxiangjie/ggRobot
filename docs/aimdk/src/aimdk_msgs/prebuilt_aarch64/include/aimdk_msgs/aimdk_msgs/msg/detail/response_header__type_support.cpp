...
{
  new (message_memory) aimdk_msgs::msg::ResponseHeader(_init);
}

void ResponseHeader_fini_function(void * message_memory)
{
  auto typed_message = static_cast<aimdk_msgs::msg::ResponseHeader *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ResponseHeader_message_member_array[2] = {
  {
    ...
    offsetof(aimdk_msgs::msg::ResponseHeader, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aimdk_msgs::msg::ResponseHeader, code),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ResponseHeader_message_members = {
  ...
  2,  // number of fields
  sizeof(aimdk_msgs::msg::ResponseHeader),
...
get_message_type_support_handle<aimdk_msgs::msg::ResponseHeader>()
{
  return &::aimdk_msgs::msg::rosidl_typesupport_introspection_cpp::ResponseHeader_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aimdk_msgs, msg, ResponseHeader)() {
  return &::aimdk_msgs::msg::rosidl_typesupport_introspection_cpp::ResponseHeader_message_type_support_handle;
}
