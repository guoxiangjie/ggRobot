...
bool aimdk_msgs__msg__system_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._system_status.SystemStatus", full_classname_dest, 42) == 0);
  }
  aimdk_msgs__msg__SystemStatus * ros_message = _ros_message;
  {  // value
...
PyObject * aimdk_msgs__msg__system_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._system_status");
