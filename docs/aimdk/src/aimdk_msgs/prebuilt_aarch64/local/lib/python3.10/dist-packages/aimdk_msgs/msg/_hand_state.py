...
class HandState(metaclass=Metaclass_HandState):
    ...
    def __init__(self, **kwargs):
        ...
        self.faultcode = kwargs.get('faultcode', int())
    ...
    def __eq__(self, other):
        ...
        if self.state != other.state:
            return False
        if self.faultcode != other.faultcode:
            return False
        return True
    ...
    def faultcode(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'faultcode' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'faultcode' field must be an integer in [-2147483648, 2147483647]"
