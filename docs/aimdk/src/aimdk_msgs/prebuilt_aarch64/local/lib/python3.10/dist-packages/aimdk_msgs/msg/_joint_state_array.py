...
class Metaclass_JointStateArray(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if DomainErrorState.__class__._TYPE_SUPPORT is None:
                DomainErrorState.__class__.__import_type_support__()
...
class JointStateArray(metaclass=Metaclass_JointStateArray):
    ...
    _fields_and_field_types = {
        ...
        'state': 'aimdk_msgs/DomainErrorState',
        'joints': 'sequence<aimdk_msgs/JointState>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['aimdk_msgs', 'msg'], 'MessageHeader'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['aimdk_msgs', 'msg'], 'DomainErrorState'),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        from aimdk_msgs.msg import DomainErrorState
        self.state = kwargs.get('state', DomainErrorState())
    ...
    def state(self, value):
        if __debug__:
            from aimdk_msgs.msg import DomainErrorState
            assert \
                isinstance(value, DomainErrorState), \
                "The 'state' field must be a sub message of type 'DomainErrorState'"
        self._state = value
