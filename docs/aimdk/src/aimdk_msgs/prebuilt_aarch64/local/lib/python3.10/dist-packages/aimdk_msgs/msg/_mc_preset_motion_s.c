...
bool aimdk_msgs__msg__mc_preset_motion__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._mc_preset_motion.McPresetMotion", full_classname_dest, 47) == 0);
  }
  aimdk_msgs__msg__McPresetMotion * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of McPresetMotion */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._mc_preset_motion");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "McPresetMotion");
