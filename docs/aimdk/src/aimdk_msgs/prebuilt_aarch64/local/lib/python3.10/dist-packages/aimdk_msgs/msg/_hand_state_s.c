...
bool aimdk_msgs__msg__hand_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._hand_state.HandState", full_classname_dest, 36) == 0);
  }
  aimdk_msgs__msg__HandState * ros_message = _ros_message;
  {  // name
  ...
  {  // faultcode
    PyObject * field = PyObject_GetAttrString(_pymsg, "faultcode");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->faultcode = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * aimdk_msgs__msg__hand_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._hand_state");
  ...
  {  // faultcode
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->faultcode);
    {
      int rc = PyObject_SetAttrString(_pymessage, "faultcode", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
