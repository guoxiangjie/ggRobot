...
bool aimdk_msgs__msg__region__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._region.Region", full_classname_dest, 29) == 0);
  }
  aimdk_msgs__msg__Region * ros_message = _ros_message;
  {  // type
  ...
  {  // drawing_type
    PyObject * field = PyObject_GetAttrString(_pymsg, "drawing_type");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->drawing_type = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // name
...
PyObject * aimdk_msgs__msg__region__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._region");
  ...
  {  // drawing_type
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->drawing_type);
    {
      int rc = PyObject_SetAttrString(_pymessage, "drawing_type", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
