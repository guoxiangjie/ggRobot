...
bool aimdk_msgs__msg__tts_priority_level__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._tts_priority_level.TtsPriorityLevel", full_classname_dest, 51) == 0);
  }
  aimdk_msgs__msg__TtsPriorityLevel * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of TtsPriorityLevel */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._tts_priority_level");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TtsPriorityLevel");
