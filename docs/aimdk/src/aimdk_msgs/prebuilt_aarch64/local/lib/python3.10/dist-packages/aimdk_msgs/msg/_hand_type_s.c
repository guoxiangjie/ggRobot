...
bool aimdk_msgs__msg__hand_type__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._hand_type.HandType", full_classname_dest, 34) == 0);
  }
  aimdk_msgs__msg__HandType * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of HandType */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._hand_type");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HandType");
