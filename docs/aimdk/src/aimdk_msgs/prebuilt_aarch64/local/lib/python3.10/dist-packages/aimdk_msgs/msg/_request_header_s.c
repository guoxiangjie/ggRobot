...
bool aimdk_msgs__msg__request_header__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.msg._request_header.RequestHeader", full_classname_dest, 44) == 0);
  }
  aimdk_msgs__msg__RequestHeader * ros_message = _ros_message;
  {  // stamp
...
PyObject * aimdk_msgs__msg__request_header__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.msg._request_header");
