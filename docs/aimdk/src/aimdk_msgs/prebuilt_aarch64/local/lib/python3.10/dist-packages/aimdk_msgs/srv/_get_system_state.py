...
class Metaclass_GetSystemState_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from aimdk_msgs.msg import SystemStatus
            if SystemStatus.__class__._TYPE_SUPPORT is None:
                SystemStatus.__class__.__import_type_support__()
...
class GetSystemState_Response(metaclass=Metaclass_GetSystemState_Response):
    ...
    _fields_and_field_types = {
        ...
        'cur_state': 'string',
        'curr_status': 'aimdk_msgs/SystemStatus',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['aimdk_msgs', 'msg'], 'CommonResponse'),  # noqa: E501
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['aimdk_msgs', 'msg'], 'SystemStatus'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.cur_state = kwargs.get('cur_state', str())
        from aimdk_msgs.msg import SystemStatus
        self.curr_status = kwargs.get('curr_status', SystemStatus())
    ...
    def __eq__(self, other):
        ...
        if self.cur_state != other.cur_state:
            return False
        if self.curr_status != other.curr_status:
            return False
        return True
    ...
    def cur_state(self, value):
        if __debug__:
            assert \
                ...
                "The 'cur_state' field must be of type 'str'"
        self._cur_state = value

    @builtins.property
    def curr_status(self):
        """Message field 'curr_status'."""
        return self._curr_status

    @curr_status.setter
    def curr_status(self, value):
        if __debug__:
            from aimdk_msgs.msg import SystemStatus
            assert \
                isinstance(value, SystemStatus), \
                "The 'curr_status' field must be a sub message of type 'SystemStatus'"
        self._curr_status = value
...
class Metaclass_GetSystemState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from aimdk_msgs.srv import _get_system_state
...
class GetSystemState(metaclass=Metaclass_GetSystemState):
    from aimdk_msgs.srv._get_system_state import GetSystemState_Request as Request
    from aimdk_msgs.srv._get_system_state import GetSystemState_Response as Response
