...
bool aimdk_msgs__srv__request_audio_focus__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.srv._request_audio_focus.RequestAudioFocus_Request", full_classname_dest, 61) == 0);
  }
  aimdk_msgs__srv__RequestAudioFocus_Request * ros_message = _ros_message;
  {  // request
...
PyObject * aimdk_msgs__srv__request_audio_focus__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimdk_msgs.srv._request_audio_focus");
...
ROSIDL_GENERATOR_C_EXPORT
bool aimdk_msgs__srv__request_audio_focus__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimdk_msgs.srv._request_audio_focus.RequestAudioFocus_Response", full_classname_dest, 62) == 0);
  }
  aimdk_msgs__srv__RequestAudioFocus_Response * ros_message = _ros_message;
  {  // reponse
